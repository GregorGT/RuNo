...
export default function Editor({
  ...
  const dropdownRef = useRef<any>(null);  // Create a ref for Dropdowns


useEffect(() => {
      // Example: Trigger handleScroll from Editor component
      if (dropdownRef.current) {
        dropdownRef.current.handleScroll();
      }
    }, []);
  ...
  return (
    ...
    // className="tiptap"
    style={{overflowY: "scroll", maxHeight: "750px" }} // Ensure it’s scrollable
    >
      <ErrorBoundary>
        <EditorProvider
          editorProps={{
