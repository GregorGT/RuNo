...
return (
  <div
    ...
    style={{
      ...
      position: "relative", // Ensure the editor container uses relative positioning for positioning the MenuBar
    }}
  >
    {/* MenuBar with sticky positioning */}
    ...
    <ErrorBoundary>
      <EditorProvider
        editorProps={{
          attributes: {
            id: "editor",
            style: `max-height:${height}px;`, // Set max-height for the editor content area
          },
        }}
        editable={true}
        children={<></>} // Empty children because the content is handled by EditorProvider
        slotBefore={null} // Remove MenuBar from EditorProvider's slotBefore
        //@ts-ignore
