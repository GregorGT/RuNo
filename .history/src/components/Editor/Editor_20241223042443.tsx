...
const handleScroll = (event: Event) => {
  ...
  return (
    <div>
    {/* Conditionally render the EditorProvider if editor is available */}
    {editor && (
      <div>
        {showToolbar && <MenuBar editorName={editorName} />} {/* Toolbar slot */}
        <EditorContent editor={editor} /> {/* Render the content of the editor */}
      </div>
    )}
  </div>
  );
