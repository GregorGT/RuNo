...
// // Trigger custom scrolling behavior when the editor view manually scrolls
// function triggerCustomScrollBehavior() {
//   manualScroll = true; // Prevent triggering the manual scroll listener in case we programmatically change the scroll position
//   if (contentDOM.scrollTop = 100; // Change scroll position programmatically for testing
//   manualScroll = false;
// }

// Trigger the function to move the scroll manually (example)
// triggerCustomScrollBehavior();

// To clean up the event listener when the editor is destroyed or unmounted
editorView.destroy = () => {
