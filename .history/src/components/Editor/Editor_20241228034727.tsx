  ...
  return (
    ...
    <div 
      ...
      style={{ 
        ...
        flex: 1,  // Ensures the content takes remaining height in the parent
        overflowY: "auto"  // Allows the content to overflow vertically
      }}>
    <Resizable direction="right" className="entries">
      <div   
            ...
            style={{
              ...
              overflowY: "scroll",  // Enable scroll if content exceeds
