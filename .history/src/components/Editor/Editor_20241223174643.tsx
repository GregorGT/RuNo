...
export default function Editor({
  ...
  return (
    ...
    >
      ...
      {/* Editor container with remaining height */}
      <div
        style={{
          flexGrow: 1, // Makes the editor take the remaining space
          overflowY: "auto", // Ensures the editor is scrollable
          borderTop: "1px solid #ccc", // Optional: Adds a border between toolbar and editor
        }}
      >
        <ErrorBoundary>
          <EditorProvider
            editorProps={{
              attributes: {
                id: "editor",
                style: `max-height:${height - (showToolbar ? 50 : 0)}px; overflow-y:auto;`, // Adjusts height if the toolbar is visible
              },
            }}
            editable={true}
            children={<></>}
