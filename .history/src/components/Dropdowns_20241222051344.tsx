...
export default function Dropdowns() {
  ...
  const handleScroll = useCallback(() => {
    ...
    // Save the chunk that was just scrolled out of view
    if (editorRef.current) {
      const currentChunk = editorChunks[currentChunkIndex];
      if (currentChunk !== getEditorValue.fn()) {
        // Update the chunk in the state if it was modified
        const updatedChunks = [...editorChunks];
        updatedChunks[currentChunkIndex] = getEditorValue.fn(); // Replace the chunk with the updated content
